...
var fs = require('fs');
var serviceAccount = require(process.cwd()+"\\civil-project-a2241-firebase-adminsdk-d94wg-b243a39f9a.json");
...
admin.auth().deleteUser(uid1)
  .then(function() {
    ...
    res.redirect('http://127.0.0.1:5500/employee.html');
  })
  .catch(function(error) {
    ...
    app.post('/myactiondelete1', urlencodedParser, function (req, res) {
      var uid1=req.body.key.toString();
          ...
          admin.database().ref().child("sites/"+uid1).remove().then(function(){
            ...
            res.redirect('http://127.0.0.1:5500/site.html');
          })
    ...
    app.post('/myaction98', urlencodedParser, function (req, res) {
      ...
      var workers=req.body.abc60.toString();
          ...
          var db = admin.database().ref().child("sites/"+siteid);
